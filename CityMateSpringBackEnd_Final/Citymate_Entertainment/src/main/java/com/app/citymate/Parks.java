...
public class Parks extends BaseEntity{
	...
	public Parks(String name, String address, String imgPath, String phoneNum, LocalTime openingTime,
	...
	public String toString() {
		return "Parks [name=" + name + ", address=" + address + ", imgPath=" + imgPath + ", phoneNum=" + phoneNum
